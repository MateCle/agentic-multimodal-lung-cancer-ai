...
# Step 2: Run end-to-end orchestrator evaluation
# Spawns vLLM, runs evaluate_orchestrator on both cohorts, kills vLLM.
# Usage: sbatch --gres=gpu:1 scripts/run_evaluation.sh
# =============================================================================
...
VLLM_PORT=8000
VLLM_LOG=logs/vllm_eval_${SLURM_JOB_ID}.log
