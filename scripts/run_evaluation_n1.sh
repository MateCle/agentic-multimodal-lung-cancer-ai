#!/bin/bash
# =============================================================================
# scripts/run_evaluation_n1.sh
# Run end-to-end orchestrator evaluation with n_candidates=1
# Usage: sbatch --gres=gpu:1 scripts/run_evaluation_n1.sh
# =============================================================================
#SBATCH --job-name=eval_n1
#SBATCH --output=logs/eval_n1_%j.log
#SBATCH --error=logs/eval_n1_%j.err
#SBATCH --gres=gpu:1
...
VLLM_PORT=8000
VLLM_LOG=logs/vllm_eval_n1_${SLURM_JOB_ID}.log
RUN_ID="n1_${SLURM_JOB_ID:-local}_$(date +%Y%m%d_%H%M%S)"
EVAL_DIR="results/evaluation/runs/n1_${SLURM_JOB_ID}"
MIN_FREE_MB=10000
